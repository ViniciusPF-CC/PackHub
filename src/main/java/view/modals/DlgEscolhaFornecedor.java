...
public class DlgEscolhaFornecedor extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        grdItens.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                grdItensMouseClicked(evt);
            }
        });
        jScrollPane3.setViewportView(grdItens);
    ...
    private Object getObjetoSelecionadoNaGrid() {
        int rowCliked = grdItens.getSelectedRow();
        Object obj = null;
        if (rowCliked >= 0) {
            obj = grdItens.getModel().getValueAt(rowCliked, -1);
        }
        return obj;
    }
